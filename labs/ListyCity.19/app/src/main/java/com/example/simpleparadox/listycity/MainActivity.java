...
public class MainActivity extends AppCompatActivity implements AddCityFragment.OnFragmentInterationListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        cityList.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                City cityedit = cityDataList.get(position);
                AddCityFragment.newInstance(cityedit).show(getSupportFragmentManager(), "EDIT_CITY");
            }
        });
